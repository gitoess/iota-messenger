...
export type InboxPartnerOption = {
  address: string
  label: string
  unreadCount?: number
  /** Letzte Nachricht im Posteingang (Sortierung Sidebar, Telegram-ähnlich). */
  lastMessageAt?: number
}

const MAX_VISIBLE_CHIPS = 5

const SOURCE_FILTERS: InboxSourceFilter[] = isIotaMessengerProduct()
  ? ['all', 'mailbox', 'group', 'lagebild']
  : ['all', 'mailbox', 'group', 'telegram', 'funk', 'lagebild']
